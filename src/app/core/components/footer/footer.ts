...
@Component({
  ...
  template: `
    <footer style="background-color: #2d485c; color: #e2e8f0;">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a href="#features" class="transition-colors hover:text-white" style="color: #cbd5e1;">Neden Neos</a></li>
          ...
          <div>
            <h4 class="text-lg font-semibold text-white mb-4">Sosyal Medya</h4>
            <div class="flex space-x-4">
              <a href="https://x.com/neos_kurumsal" target="_blank" rel="noopener noreferrer" class="transition-colors hover:text-white" style="color: #cbd5e1;" aria-label="Twitter">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/neos.danismanlik/" target="_blank" rel="noopener noreferrer" class="transition-colors hover:text-white" style="color: #cbd5e1;" aria-label="Instagram">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-8 pt-8 text-center text-sm" style="border-top: 1px solid rgba(45, 72, 92, 0.5); color: #94a3b8;">
          <p>&copy; {{ currentYear }} Neos. Tüm hakları saklıdır.</p>
        </div>
      </div>
    </footer>
  `,
